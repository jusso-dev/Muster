...
export const connectorPresets: Record<string, readonly QueryTemplate[]> = {
  ...
  unifi: [
    {
      key: "unifi.sites.list",
      version: 1,
      displayName: "UniFi sites",
      method: "GET",
      pathTemplate: "/v1/sites?offset={offset}&limit={limit}",
      ...
      outputSchema: {
        type: "object",
        required: ["offset", "limit", "count", "totalCount", "data"],
        properties: {
          offset: { type: "integer" },
          limit: { type: "integer" },
          count: { type: "integer" },
    ...
    {
      key: "unifi.devices.list",
      version: 1,
      displayName: "UniFi adopted devices",
      method: "GET",
      pathTemplate:
        "/v1/sites/{siteId}/devices?offset={offset}&limit={limit}&filter={filter}",
      requiredCapability: "unifi.network.read",
      inputSchema: {
        type: "object",
